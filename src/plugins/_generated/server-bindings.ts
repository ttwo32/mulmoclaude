...
import manageFeedDef from "../manageFeed/definition";
...
import { META as manageFeedMeta } from "../manageFeed/meta";
...
export const GENERATED_SERVER_BINDINGS: readonly ServerPluginBinding[] = [
  ...
  { def: manageFeedDef, endpoint: mcpEndpoint(manageFeedMeta) },
